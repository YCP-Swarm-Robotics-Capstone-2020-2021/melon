...
bool ArenaDetector::detect(cv::Mat& frame,
                           ...
                           bool draw_center)
{
    ...
    else
    {
           ...
           marker_map.find(3) != marker_map.end())
        {
            ...
            mask_edges[0].push_back(marker_map.at(0).corners[2]);
            mask_edges[0].push_back(marker_map.at(1).corners[3]);
            mask_edges[0].push_back(marker_map.at(2).corners[0]);
            mask_edges[0].push_back(marker_map.at(3).corners[1]);
            ...
            m_center_pixel[0] = (marker_map.at(0).corners[2].x + marker_map.at(2).corners[0].x)/2.0;
            m_center_pixel[1] = (marker_map.at(0).corners[2].y + marker_map.at(2).corners[0].y)/2.0;
